...
Las siguientes actividades se encuentran basadas en Herramientas específicas para el grupo de \emph{SQA} [WEB-00].
...
En la siguiente tabla se adjunta la matriz de responsabilidades [WEB-00].
